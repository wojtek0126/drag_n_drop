...
import { dynaHeight } from '../recoil/recoil';
...
const Page = () => {
  ...
  // getting container height modified by module movement from recoil
  const hGrowth = useRecoilValue(dynaHeight);
  ...
  return (
    <Box
      ...
      position="relative"
      width={1024}
      height={ !hGrowth ? containerHeight : hGrowth}
      margin="auto"
      sx={{
        overflow: 'hidden',
